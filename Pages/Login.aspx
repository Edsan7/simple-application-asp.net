<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Site.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="WebApplication2.Login" %>
 ...
 <div class="content-wrapper margin-top-60px">
        <div class="row">
            <div class="col-3 box-padding-30px box-border">
                ...
                <label>Senha</label>
                <asp:TextBox ID="Senha" type="password" runat="server"></asp:TextBox>
